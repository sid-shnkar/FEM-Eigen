 ...
 * For Numerical solution of Problem 1(constant area), we have used 2-point gauss quadrature
**/
double gaussQuadrature(int diff1, int diff2, double E, double A0, int N, double L){
        ...
        for(int i=0; i<n; i++){
        // phi(x) will be a constant polynomial for problem 1 (constant area), so the formula for I reduces to the following
...
int main(int argc, char *argv[])
{
    ...
    */
    for(int i=0; i < myDomain.getN(); i++){
        elemental_matrix(i, 0) = gaussQuadrature(1, 1, myDomain.getE(), myDomain.getA0(), myDomain.getN(), myDomain.getL());
        elemental_matrix(i, 1) = gaussQuadrature(1, -1, myDomain.getE(), myDomain.getA0(), myDomain.getN(), myDomain.getL());
        elemental_matrix(i, 2) = gaussQuadrature(-1, 1, myDomain.getE(), myDomain.getA0(), myDomain.getN(), myDomain.getL());
        elemental_matrix(i, 3) = gaussQuadrature(-1, -1, myDomain.getE(), myDomain.getA0(), myDomain.getN(), myDomain.getL());
    }
